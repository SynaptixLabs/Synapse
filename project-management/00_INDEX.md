# SYNAPSE — documentation index (graph root)
...
- [`0m_BACKLOG.md`](0m_BACKLOG.md) — post-POC backlog (v0.2 wants; every item founder-flagged).
...
- **[`sprints/00_index.md`](sprints/00_index.md)** — the sprint index node → each
  `sprint_<N>/index.md` (**POC v0.1.0 closed** — sprints 01–03 all closed on founder PASS).
...
├── 0k_PRD.md · 01_ARCHITECTURE.md · 0l_DECISIONS.md · 0m_BACKLOG.md
├── 03_MODULE_CONTRACTS.md   (must-read: reuse protocol + registry)
├── sprints/00_index.md      -> sprint_<N>/index.md -> { todo, reviews, reports, acceptance }
